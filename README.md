...
SAMPLE FILE:
============
Sample file is required fthe program. This file should have the following format. Please don't change the format of the file. Simply replace the fastq, sam and the conditions of the sample.
...
In case of SALMON:
        ...
        FASTQ sampleCtrl_3.R1.fq sampleCtrl_3.R2.fq sal_quantntrol
        #
        #       End of file "sample"
        #
...
------------------
        ...
        R pages are available in the EPEL repositories. It can be installed by typing:
